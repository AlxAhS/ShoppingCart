...
{
    public class StoreSettingBooksController : Controller
    {
        private readonly ApplicationDbContext _context;

        public StoreSettingBooksController(ApplicationDbContext context)
        {
            _context = context;
        }
